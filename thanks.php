<?php
  $assetPath = '/src';
  $stylePath = $assetPath . '/css';
  $imagePath = $assetPath . '/images/thanks';
...
<html>
  <head>
    ...
    <title>WelcomeHR</title>
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@300;400;500;700;900&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="<?= $stylePath ?>/common.css" />
    <link rel="stylesheet" href="<?= $stylePath ?>/thanks.css" />
    <!-- remove -->
    <script type="text/javascript" src="./jquery-3.5.1.min.js"></script>
    <!-- /remove -->
  </head>
  <body class="time-saving-calculator-thanks-page">
    <div class="main-body">
      <div class="success">
